...
import 'package:uumstaff_healthprofile/loginPanel.dart';
...
class _registerPanelState extends State<registerPanel> {
  ...
  Future<void> _onRegister() async {
    ...
    _staffID = _staffIDcontroller.text;
    ...
    if (validateEmail(_email) && validatePassword(_pass) && _pass.length > 5) {
      ...
      http.post("https://joshuaooigy.com/uumstaffhealthprofile/php/register_user.php",
          body: {
            "name": _name,
            "staffID": _staffID,
            "email": _email,
